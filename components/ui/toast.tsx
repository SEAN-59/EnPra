  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        'data-limited:[transform:translateX(150%)] data-limited:opacity-0 data-starting-style:[transform:translateY(150%)]',
...
function Toaster({
  ...
  return (
    <ToastProvider toastManager={toastManager} limit={3} timeout={3_000} {...props}>
      {children}
      <ToastPortal>
        <ToastViewport>
          <ToastList />
