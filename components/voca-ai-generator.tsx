...
export function VocaAIGenerator() {
  ...
  async function generateVocabulary() {
    ...
    try {
      ...
      let result: { status?: 'running' | 'completed' | 'failed'; listId?: number; addedCount?: number; attempts?: number; error?: string };
      do {
