    ...
    <AppShell activeSection="VOCA" displayName={user.displayName} signOutHref={chatGPTSignOutPath('/voca')}>
      <section className="min-w-0">
        <div className="flex flex-wrap items-end justify-between gap-5">
          ...
          <div className="flex items-center gap-2"><VocaSettings /><Button className="h-11 rounded-xl bg-[#1d2935] px-4 text-[#fffdf8] hover:bg-[#344451]"><Sparkles className="size-4" aria-hidden="true" />AI로 단어 만들기</Button></div>
        </div>
