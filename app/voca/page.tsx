      ...
      <section className="min-w-0">
        ...
        <div className="mt-7 grid gap-4 lg:grid-cols-[1.25fr_.75fr]">
          <section className="rounded-3xl border border-[#dcd6ca] bg-[#fffdf8] p-6 shadow-[0_18px_48px_rgba(35,44,43,0.05)] sm:p-8">
            ...
            <div className="mt-7 flex flex-wrap gap-3"><Button asChild size="lg" className="h-11 rounded-xl bg-[#1d2935] px-5 text-[#fffdf8] hover:bg-[#344451]"><a href="/voca#practice">학습하기 <ArrowRight className="size-4" aria-hidden="true" /></a></Button><Button asChild size="lg" variant="outline" className="h-11 rounded-xl border-[#d3cbbe] bg-[#fffdf8] px-5 text-[#43504e] hover:bg-[#f2ede4]"><a href="/voca#test">테스트 <ClipboardCheck className="size-4" aria-hidden="true" /></a></Button></div>
          </section>
