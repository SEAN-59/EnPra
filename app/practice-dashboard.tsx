    ...
    <main className="min-h-screen bg-[#f7f4ed] text-[#1d2935]">
      ...
      <aside aria-label="학습 메뉴" className={`fixed inset-y-0 left-0 z-50 flex w-[min(20rem,calc(100vw-1.5rem))] flex-col border-r border-[#dcd6ca] bg-[#fffdf8] p-5 shadow-[16px_0_45px_rgba(29,41,53,0.14)] transition-transform duration-200 lg:hidden ${leftDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <nav aria-label="학습 메뉴" className="mt-8 space-y-1 text-sm">
          <a onClick={() => setLeftDrawerOpen(false)} className="flex items-center gap-3 rounded-lg bg-[#e9e5dc] px-3 py-3 font-semibold" href="#today"><BookOpen className="size-4 text-[#e9784f]" aria-hidden="true" />HOME</a>
          ...
          <a onClick={() => setLeftDrawerOpen(false)} className="flex items-center gap-3 rounded-lg px-3 py-3 text-[#66706d] hover:bg-[#ebe7dd]" href="#today"><PenLine className="size-4" aria-hidden="true" />WRITING</a>
      ...
      <div className="mx-auto grid max-w-7xl gap-7 px-5 py-7 lg:grid-cols-[218px_minmax(0,1fr)_260px] lg:px-8 lg:py-10">
        <aside className="hidden lg:block"><div className="sticky top-8 space-y-7">
          ...
          <section id="library" className="px-1"><p className="mb-3 text-[10px] font-bold tracking-[0.16em] text-[#8b918b] uppercase">Practice</p><div className="space-y-1 text-sm"><a className="flex items-center gap-3 rounded-lg bg-[#e9e5dc] px-3 py-2.5 font-semibold" href="#today"><BookOpen className="size-4 text-[#e9784f]" aria-hidden="true" />HOME</a><a className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#66706d] hover:bg-[#ebe7dd]" href="#library"><SpellCheck className="size-4" aria-hidden="true" />VOCA</a><a className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#66706d] hover:bg-[#ebe7dd]" href="#library"><BookOpen className="size-4" aria-hidden="true" />READING</a><a className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#66706d] hover:bg-[#ebe7dd]" href="#library"><Headphones className="size-4" aria-hidden="true" />LISTENING</a><a className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#66706d] hover:bg-[#ebe7dd]" href="#today"><PenLine className="size-4" aria-hidden="true" />WRITING</a><a className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#66706d] hover:bg-[#ebe7dd]" href="#library"><Mic className="size-4" aria-hidden="true" />SPEAKING</a></div></section>
